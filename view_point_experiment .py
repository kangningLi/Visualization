...
point_cloud= np.fromfile("/home/kangning/Documents/Masterarbeit/frustum-pointnets/dataset/KITTI/object/training/velodyne/000020.bin",dtype=np.float32).reshape(-1,4)
